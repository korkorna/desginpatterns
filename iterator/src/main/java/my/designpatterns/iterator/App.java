...
public class App 
{
    public static void main( String[] args )
    {
		...
		dinerMenu.add(new MenuItem("BLT", "통밀 위에 베이컨, 상추, 토아토를 얹은 메뉴", false, 2.99));
    	...
    	dinerMenu.add(new MenuItem("파스타", "마리나라 소스 스파게트", true, 3.89));
		...
		cafeMenu.add(new MenuItem("베리토", "통 핀토콩과 살사, 구아카몰이 곁들여진 푸짐한 베리또", true, 4.29));
